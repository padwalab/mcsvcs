...
import (
	...
	"github.com/padwalab/mcsvcs/pkg/custom/transport"
...
func main() {
	var (
		httpAddr = net.JoinHostPort("localhost", envString("HTTP_PORT_CUSTOM", defaultHTTPPort))
	)
	var (
		service     = custom.NewService()
